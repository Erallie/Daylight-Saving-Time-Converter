...
To use it, to go the link: `https://dst.gozarproductions.com/?t=XX:XX&tz=Country/City` where:
...
- `https://dst.gozarproductions.com/?t=13:00&tz=America/Phoenix`

You can *also* go to this page in order to generate a link more easily:
- https://dst.gozarproductions.com/generator.html
